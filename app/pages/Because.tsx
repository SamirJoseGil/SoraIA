            ...
            <div ref={whySoraiaRef} className="container relative mx-auto px-4 z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
                    ...
                    >
                        ...
                        <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/10 via-transparent to-blue-500/10 rounded-xl blur opacity-20 group-hover:opacity-30 transition duration-500"></div>

                        <div className="relative z-10">
                            <div
                                className={`bg-blue-500/20 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center backdrop-blur-sm transition-all duration-700 ${animationsStarted ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}
                                style={{ transitionDelay: '600ms' }}
                            >
                    ...
                    >
                        {/* Background glow effect */}
                        <div className="absolute -inset-1 bg-gradient-to-r from-purple-500/10 via-transparent to-purple-500/10 rounded-xl blur opacity-20 group-hover:opacity-30 transition duration-500"></div>

                        <div className="relative z-10">
                            <div
                                className={`bg-purple-500/20 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center backdrop-blur-sm transition-all duration-700 ${animationsStarted ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}
                    ...
                    >
                        {/* Background glow effect */}
                        <div className="absolute -inset-1 bg-gradient-to-r from-green-500/10 via-transparent to-green-500/10 rounded-xl blur opacity-20 group-hover:opacity-30 transition duration-500"></div>

                        <div className="relative z-10">
                            <div
                                className={`bg-green-500/20 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center backdrop-blur-sm transition-all duration-700 ${animationsStarted ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}
                    ...
                    >
                        {/* Background glow effect */}
                        <div className="absolute -inset-1 bg-gradient-to-r from-orange-500/10 via-transparent to-orange-500/10 rounded-xl blur opacity-20 group-hover:opacity-30 transition duration-500"></div>

                        <div className="relative z-10">
                            <div
                                className={`bg-orange-500/20 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center backdrop-blur-sm transition-all duration-700 ${animationsStarted ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}
