      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-soraia-light">Transformamos ideas en software real.</p>
            <div className="mt-4 flex space-x-4">
              <a href="#" className="text-soraia-light hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <span className="text-soraia-light">info@soraia.com</span>
              </div>
              ...
              <div className="flex items-start">
                ...
                <span className="text-soraia-light">+34 123 456 789</span>
              </div>
              ...
              <div className="flex items-start">
                ...
                <span className="text-soraia-light">Calle Imaginaria 123, Madrid, España</span>
              </div>
            </div>
          </div>
        </div>
        
        <div className="border-t border-soraia-muted/30 mt-8 pt-8 text-center text-soraia-light">
          <p>&copy; {new Date().getFullYear()} Soraia. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
