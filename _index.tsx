...
function ServiceCard({ title, description, icon, delay = 0 }: ServiceCardProps) {
  ...
  return (
    ...
    >
      ...
      <p className="text-soraia-dark">{description}</p>
      <a href="#" className="mt-6 inline-block px-6 py-2 bg-soraia-primary text-white rounded-lg hover:bg-soraia-secondary hover:shadow-lg transition-all transform hover:scale-105">
        Saber más
      </a>
    </div>
  );
...
export default function Index() {
  ...
  // Agregamos las refs y estados para las otras secciones
  ...
  // Agregamos el estado para la sección activa
  ...
  return (
    <div className="bg-soraia-light">
      {/* Ahora pasamos la prop correctamente */}
      <Header activeSection={activeSection} />

      {/* Hero Section */}
      <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-soraia-light via-soraia-accent/20 to-soraia-primary/40 relative overflow-hidden">
        {/* Resto del código... */}
        <div
          ref={heroRef}
      ...
      <section id="services" className="py-20 bg-soraia-light">
        {/* Añadimos la ref a la sección de servicios */}
        <div ref={servicesRef} className="container mx-auto px-4">
          ...
          {/* Cambiamos a 3 columnas en lugar de 4 */}
      ...
      <section id="contact" className="py-20 bg-white">
        {/* Añadimos la ref a la sección de contacto */}
